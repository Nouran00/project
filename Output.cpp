...
{
	///TODO: implement the following function as described in Output.h file
	int x=(UI.CellHeight* cellPos.VCell() + UI.ToolBarHeight);
	return x; // this line should be changed with your implementation
}
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_ADD_COIN_SET]= "images\\coinset.jpg" ;
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_INPUT_DICE_VALUE]="images\\input2.jpeg";
	MenuItemImages[ITM_OFFER_MORTGAGE]="images\\offer_mortgage.jpg";
	MenuItemImages[ITM_ACCEPT_MORTGAGE]="images\\accept_mortgage.jpg";
	MenuItemImages[ITM_RETURN_MORTGAGE]="images\\return_mortgage.jpg";
	MenuItemImages[ITM_SELL_CITY]="images\\sell_image.jpg";
	MenuItemImages[ITM_NEW_GAME]="images\\new_game.jpg";
	MenuItemImages[ITM_NEW_EXIT]="images\\Menu_Exit.jpg";
...
{
	///TODO: Clear what was written on the toolbar using CreatePlayModeToolBar() function of the OUtput class
...
void Output::DrawLadder(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	pWind->SetPen(UI.LadderColor,UI.LadderlineWidth);
	for (int i=0; i< fromCell.VCell()- toCell.VCell() ; i++)
	{
		pWind->DrawLine(x12, fromStartY-(UI.CellHeight*i), x34, fromStartY-(UI.CellHeight*i));
	}
